...
export const ChangePassword: React.FC = () => {
  ...
  return (
    <div className="page-enter flex min-h-screen items-center justify-center px-4 py-8 will-animate">
      <div className="modal-slide-up w-full max-w-md rounded-3xl border border-white/60 bg-white/75 p-7 shadow-2xl shadow-slate-900/10 backdrop-blur-2xl sm:p-10">
